...
```json
{
  ...
  "sfx": false,
  "created": "2026-04-27 03:18:21.744376"
}
```
...
```bash
python3 video_generator_pro.py -p acb
```
...
```bash
python3 video_generator_pro.py -p acb     --scene-fade 0.3     --subtitle --subtitle-animation slide_up     --transition pixelize     --watermark logo.png     --watermark-position bottom-right     --sfx
```

---
*生成时间: 2026-04-27 03:18:21*
